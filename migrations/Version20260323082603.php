 ...
 */
final class Version20260323082603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile DROP background_image');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD background_image VARCHAR(50) DEFAULT NULL');
