 ...
 */
final class Version20260205133935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE file_path file_path VARCHAR(255) NOT NULL, CHANGE thumbnail_path thumbnail_path VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE file_path file_path VARCHAR(500) NOT NULL, CHANGE thumbnail_path thumbnail_path VARCHAR(500) DEFAULT NULL');
