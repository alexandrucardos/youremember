 ...
 */
final class Version20260205122241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE thumbnail_path thumbnail_path VARCHAR(500) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE thumbnail_path thumbnail_path VARCHAR(500) NOT NULL');
