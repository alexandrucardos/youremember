...
{
    public const NAME_MEDIA_CLIENT_BACKGROUND_ADD = 'api_media_client_background_add'; // skip
    public const NAME_MEDIA_CLIENT_BACKGROUND_GET = 'api_media_client_background_get'; // skip
    public const NAME_MEDIA_CLIENT_GET = 'api_media_client_get'; // skip
    public const NAME_MEDIA_CLIENT_ADD = 'api_media_client_add'; //done
    public const NAME_MEDIA_CLIENT_DELETE = 'api_media_client_delete'; // done
    public const NAME_MEDIA_CLIENT_MULTIPART_INITIATE = 'api_media_client_multipart_initiate'; // done
    public const NAME_MEDIA_CLIENT_MULTIPART_PART = 'api_media_client_multipart_part'; // done
    public const NAME_MEDIA_CLIENT_MULTIPART_COMPLETE = 'api_media_client_multipart_complete'; // done
    public const NAME_MEDIA_CLIENT_MULTIPART_ABORT = 'api_media_client_multipart_abort'; // done
    public const NAME_MEDIA_GUEST_ADD = 'api_media_guest_add'; //done
    public const NAME_MEDIA_GUEST_DELETE = 'api_media_guest_delete'; //done
    public const NAME_MEDIA_GUEST_MULTIPART_INITIATE = 'api_media_guest_multipart_initiate'; //done
    public const NAME_MEDIA_GUEST_MULTIPART_PART = 'api_media_guest_multipart_part'; //done
    public const NAME_MEDIA_GUEST_MULTIPART_COMPLETE = 'api_media_guest_multipart_complete'; //done
    public const NAME_MEDIA_GUEST_MULTIPART_ABORT = 'api_media_guest_multipart_abort'; //done
    ...
    #[Route(
        '/client/{orderId}/multipart/initiate',
        name: self::NAME_MEDIA_CLIENT_MULTIPART_INITIATE,
        methods: ['POST']
    )]
    public function clientMultipartInitiate(
        ...
        $result = $mediaPresignService->initiateMultipartUpload(
            $orderId->value,
            $filename,
            $mimeType,
    ...
    #[Route(
        '/client/{orderId}/multipart/complete',
        name: self::NAME_MEDIA_CLIENT_MULTIPART_COMPLETE,
        methods: ['POST']
    )]
