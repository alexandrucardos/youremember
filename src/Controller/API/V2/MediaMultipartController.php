...
final class MediaMultipartController extends AbstractController
{
    ...
    #[Route('/initiate/eventUuid/{uuid}', name: self::NAME_MEDIA_GUEST_MULTIPART_INITIATE, methods: ['POST'])]
    ...
    #[Route('/part/eventUuid/{uuid}', name: self::NAME_MEDIA_GUEST_MULTIPART_PART, methods: ['POST'])]
